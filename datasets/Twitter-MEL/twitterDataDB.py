...
consumer_key = "ZCUmi4T1pTizsf0YifSDBHpUy"
consumer_secret = "ZF6vlVApObzzbKc1XhIOBcpISnlHlARkj6wVQnLtVROBC2abLZ"
access_key = "1334056542497239040-CGX5rCmLGFBBe06e7LeCmEiMcf69gu"
access_secret = "ZmA1a8c7hthei8HgX1hkFmYKMyT53vRtmwDceQj4NBlu8"
...
def getUserData(screen_name ,api, queryType, db):
    ...
    try:
        ...
        for tweet_status in status:
            print('*************************************************')
            import json
            with open('status.json', 'w') as f_obj:
                for sta in status:
                    json.dump(sta._json, f_obj, indent=4)
            print('*************************************************')
...
def main(argv):
    ...
    #print(api.get_user(id='996094929733652481'))988355899503923200
    print(api.get_user(id='1091711401826152449'))
    # print(api.user_timeline(screen_name='@hanghanghang18', count=200, tweet_mode='extended', include_rts=False,
    #                      exclude_replies=False)[0]._json)
